...
export const projects = [
  ...
  {
    id: 3,
    name: "SwiftLogistics System",
    description:
      "Enterprise Service Bus (ESB) middleware solution for integrating three heterogeneous legacy systems. Built middleware to connect CMS (JSON), WMS (TCP/IP), and ROS (SOAP) systems with Flask-based API integration and comprehensive testing framework.",
    technologies: [SiPython, SiFlask],
    techNames: ["Python", "Flask"],
    techLinks: [
      "https://www.python.org/",
      "https://flask.palletsprojects.com/",
    ],
    github:
      "https://github.com/nikilasilva/Middleware_Architecture_SwiftLogistics",
    demo: "https://github.com/nikilasilva/Middleware_Architecture_SwiftLogistics",
    image: "/projects/swiftlogistics.webp",
    available: true,
  },
];
